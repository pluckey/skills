...
- **Mid-execution architecture audit catches structural bugs**: For specs touching >5 files or involving state machine changes, run a Jacobi-inversion audit after build phases complete.
