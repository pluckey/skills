...
| phases/execution.md | Imperative | Build from the task list |
...
| prompts/destroyer.md | Template | Destroyer gate evaluation prompt |
| lint-spec.mjs | Verification | Structural integrity checks (P1-P9, F1-F6) |
